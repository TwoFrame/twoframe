...
const config: Config = {
  ...
  content: [
    ...
    "./node_modules/@nextui-org/theme/dist/components/(alert|button|card|date-picker|form|image|input|navbar|spinner|toggle|tabs|user|ripple|calendar|date-input|popover|avatar).js"
  ],
