...
export default function DashboardNavBar() {
  ...
  return (
    <Sidebar style={{ borderRight: "none", height: "100%" }}>
      <SidebarHeader>
        <Link
          className="inline-flex w-fit items-center gap-4 font-micro text-3xl text-white p-2"
          href="/"
          ...
          <SidebarGroupContent>
            ...
            */}
              ...
              <SidebarMenuItem key="manage" className="my-1">
                <SidebarMenuButton
                  isActive={pathname == "/dashboard/tournaments/collections"}
                >
      ...
      <SidebarFooter>
        <section className="px-2">
          <User
            ...
            description={
              <Link href="https://x.com/jrgarciadev">@testUserName</Link>
            }
            name="Test User"
          />
        </section>
