        ...
        <section className="flex flex-col bg-background-default h-screen w-full">
            ...
            <section className="dashboard-nav flex items-center justify-between">
                <Breadcrumbs color="primary">
                    ...
                    <BreadcrumbItem href={`/dashboard/tournaments/${params.slug}?context=${context}`}><h1 className="text-lg font-semibold text-white">{params.slug}</h1></BreadcrumbItem>
                    <BreadcrumbItem><h1 className="text-lg font-semibold">Events</h1></BreadcrumbItem>
                </Breadcrumbs>
